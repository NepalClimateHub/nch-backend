...
export const GetRequestDTO = (schema: ZodObject<any>, other?: OtherRequestType): ZodRequestBody => {
    return {
        content: {
            "application/json": {
                schema: schema,
...
export const GetResponseDTO = (responseSchema: ZodObject<any>, other?: OtherResponseType): ResponseDTOType => {
    return {
        200: {
            content: {
                "application/json": {
